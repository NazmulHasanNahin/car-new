        ...
        <div>
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end space-x-2">
                    <div className="p-2 bg-[#FF3811] rounded-lg justify-center items-center gap-2.5 inline-flex">
                        <Link to={"/login"} className="text-center text-white text-lg font-semibold ">Sign In</Link>
                    </div>
                    <div className="p-2 bg-[#59c6d2] rounded-lg justify-center items-center gap-2.5 inline-flex">
                        <Link to={"/reg"} className="text-center text-white text-lg font-semibold ">Sign Up</Link>
                    </div>
                </div>
            </div>
        </div>
